...
void chatScreen::run() {
    ...
    if(user.getProfilePicture() == 1){
        ui->buttonUserPicture->setIcon(QIcon("../icons/SDI-photo-1.png"));
        ui->buttonUserPicture->setIconSize(QSize(50,50));
    } else if(user.getProfilePicture() == 2){
        ui->buttonUserPicture->setIcon(QIcon("../icons/SDI-photo-2.png"));
        ui->buttonUserPicture->setIconSize(QSize(50,50));
    } else if(user.getProfilePicture() == 3){
        ui->buttonUserPicture->setIcon(QIcon("../icons/SDI-photo-3.png"));
        ui->buttonUserPicture->setIconSize(QSize(50,50));
    } else if(user.getProfilePicture() == 4){
       ui->buttonUserPicture->setIcon(QIcon("../icons/SDI-photo-4.png"));
       ui->buttonUserPicture->setIconSize(QSize(50,50));
    }
