...
void profileScreen::run(){
    ...
    ui->buttonPicture1->setIcon(QIcon("../icons/SDI-photo-1.png"));
    ui->buttonPicture1->setIconSize(QSize(50,50));

    ui->buttonPicture2->setIcon(QIcon("../icons/SDI-photo-2.png"));
    ui->buttonPicture2->setIconSize(QSize(50,50));

    ui->buttonPicture3->setIcon(QIcon("../icons/SDI-photo-3.png"));
    ui->buttonPicture3->setIconSize(QSize(50,50));

    ui->buttonPicture4->setIcon(QIcon("../icons/SDI-photo-4.png"));
